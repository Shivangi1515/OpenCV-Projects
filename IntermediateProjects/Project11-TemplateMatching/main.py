...
img=cv.imread('IntermediateProjects\Project11-TemplateMatching\img.jpg',0)
# template=cv.imread('IntermediateProjects/Project10-TextDetectionAndExtraction/Project11-TemplateMatching/football.jpg',0)
template=cv.imread('IntermediateProjects\Project11-TemplateMatching\Left_leg.jpg',0)
